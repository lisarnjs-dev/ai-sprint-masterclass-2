...
const testimonials = [
  {
    id: 1,
    quote:
      "혼자서 바이브코딩 조작조작 해봤는데 독학으론 한계가 있었어요. 강의가 파트별로 짧게 나뉘어져 있어서 제 일정에 맞춰 듣기 편했고, 피로도가 훨씬 줄었어요. 부담없이 자주자주 들어가게 되는 것 같아요.",
    author: "1기 수강생",
    topic: "독학의 한계 → 완주",
  },
  {
    id: 2,
    quote:
      "항상 아이디어를 구현하고 싶다는 생각이 있었는데, 어디서부터 시작해야 할지 막막했어요. 주차별 진도표가 있어서 목표를 명확히 가져갈 수 있고, AI 초심자 입장에서 강의 대로 집중할 수 있어서 좋습니다.",
    author: "1기 수강생 (직장인)",
    topic: "아이디어 → 실제 배포",
  },
  {
    id: 3,
    quote:
      "처음엔 바이브코딩 해야 되는데... 하는 무거운 마음이 컸는데, 지금은 일단 시작해보자는 마인드로 많이 바뀌었어요. 모각코 시간이랑 쌤께 언제든 질문드릴 수 있다는 든든함 덕분인 것 같아요. 모각코도 너무 귀여워요, 빠지기 싫어요.",
    author: "1기 수강생",
    topic: "모각코가 완주의 핵심",
  },
  {
    id: 4,
    quote:
      "주차별 강의가 짧게 나뉘어 있어서 부담없이 들을 수 있어요. 주차별 미션이 있어서 학습 동기부여가 됐고, 오프라인 네트워킹 파티도 기대됩니다.",
    author: "1기 수강생",
    topic: "주차별 미션 + 동기부여",
  },
  {
    id: 5,
    quote:
      "이 클래스의 최대 장점은 쌤의 무한한 피드백을 들을 수 있다는 점인 것 같아요. 리사쌤이 내 뒤에 있다!",
    author: "1기 수강생 (프리랜서)",
    topic: "리사쌤이 내 뒤에 있다",
  },
];
